...
import net.janrupf.ujr.example.simple.window.WindowController;
import net.janrupf.ujr.example.simple.bridge.FilesystemBridge;
import net.janrupf.ujr.example.simple.bridge.GlfwClipboardBridge;
import net.janrupf.ujr.example.simple.bridge.LoggerBridge;
import net.janrupf.ujr.example.simple.surface.GlfwSurfaceFactory;
